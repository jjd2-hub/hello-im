package com.him.implatform.thirdparty;

import cn.hutool.core.util.IdUtil;
import com.him.imcommon.util.DateTimeUtil;
...
public class MinioService {
    ...
    public String upload(String bucketName, String path, MultipartFile file) {
        ...
        String objectName = DateTimeUtil.getFormatDate(new Date(), DateTimeUtil.PREFORMATTED) + "/" + fileName;
        try {
